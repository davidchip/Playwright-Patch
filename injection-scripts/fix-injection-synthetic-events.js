...
// Create the final injection block with Playwright API integration
const injection = `
  
  // ANIMAKE INJECTION START
  console.log('🎭 Animake: Injecting interactive toolset with Playwright API...');
  ...
  try {
    await context.addInitScript(() => {
      ...
      function executeRandomText(element, selector) {
        ...
        // Use synthetic events that Playwright can detect
        setTimeout(() => {
          ...
          // Simulate typing the new value character by character
          let currentValue = '';
          for (let i = 0; i < value.length; i++) {
            setTimeout(() => {
              ...
              // Dispatch events that Playwright listens for
            ...
            }, i * 50); // Delay each character slightly
          }
        }, 100);
    ...
    console.log('🎭 Animake: Interactive toolset with synthetic events injected successfully.');
  } catch (error) {
...
console.log('✅ Injected interactive Animake toolset with synthetic keyboard events.');
